        ...
        return (
            <div className="section-nav">
                <div className="lead-logo">
                    <img src="https://media.glassdoor.com/sqll/1071394/docplanner-squarelogo-1515684466717.png" />
                </div>
                <div className="text">
                ...
                <div className="doctors-parents">
                    <div className="fade-elements col1">
                        <div className="services-items1">
                            <h2>For patients</h2>
                            ...
                            <div>
                                <div className="style-select">
                                    <select className="domain-switcher">
                                        ...
                                        <option vale="http://www.doctoralia.co.uk">UK</option>
                                    </select>
                    ...
                    <div className="fade-elements col2">
                        <div className="services-items2">
                            <h2>For Doctors</h2>
                            <h1>Save time managing visits and cut no-shows by half</h1>
                            <figure className="services-figure2">
                ...
                <div className="icone-section">
                    ...
                    <ul className="logos-section">
                        <li><a href="//www.doctoralia.es" target="_blank">
                        ...
                        <li><a href="//www.miodottore.it" target="_blank">
                        ...
                        <li><a href="//www.doktortakvimi.com" target="_blank">
                        ...
                        <li><a href="//www.znamylekar.cz" target="_blank">
                        ...
                        <li><a href="https://www.znanylekarz.pl/?_ga=2.221373016.1705168611.1571600712-1332163445.1571600712"
                            target="_blank">
